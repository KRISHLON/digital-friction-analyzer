    ...
    return (
        <aside className="sidebar" style={{
            ...
            <nav style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem', flex: 1 }}>
                ...
                <NavLink to="/dashboard" icon="📊" label="Dashboard" active={location.pathname === '/dashboard'} />
                
                <SectionLabel>explore</SectionLabel>
                <NavLink to="/features" icon="✨" label="Features" active={location.pathname.startsWith('/features')} />
                <NavLink to="/services" icon="⚡" label="Services" active={location.pathname === '/services'} />
                <NavLink to="/pricing" icon="💎" label="Pricing" active={location.pathname === '/pricing'} />
                
                <SectionLabel>support</SectionLabel>
                <NavLink to="/details" icon="ℹ️" label="Details" active={location.pathname === '/details'} />
                <NavLink to="/form" icon="📝" label="Contact" active={location.pathname === '/form'} />
            </nav>
